...
В последнем подходе, мы сохраняем версию глобального объекта внутри при конструировании:
\begin{cppcode}
class A {
public:
  A() = default;
...
\begin{enumerate}
\item В строке $23$ заводится глобальный объект типа \verb"Counter".
...
\item В строках с $4$-й по $21$-ю каждый метод просто увеличивает свой счетчик внутри глобального \verb"GCounter".
\end{enumerate}
